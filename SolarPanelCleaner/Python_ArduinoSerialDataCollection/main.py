...
class Application:
    # the code created will be explained
    ...
    def __init__(self, *args, **kwargs):
        ...
        layout = [[sg.Text('GET ACCELEROMETER GYROSCOPE', font=headerFont)],
        ...
        self.window = sg.Window('Serial Application', layout, size=(700, 700), keep_on_top=True)
            ...
            while n < sample_num:
                ...
                try:
                    ...
                    if data is not None:
                        ...
                        if n == 0:
                            gui_queue.put(' Data Transmitting  ')
                        ...
                        if len(decode_string.split(',')) == 6:
                            ...
                            self.csv_writer('LoggedData.csv', n, decode_string)
